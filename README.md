...
- Perform the operation:
   - If addition, subtraction, multiplication, or division, return the result.
   - If the operation is division, ensure the denominator is not zero.
  - For any other operation, return an "invalid operation" message.
